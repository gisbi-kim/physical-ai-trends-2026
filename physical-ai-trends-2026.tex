...
\begin{profbox}[Fleet에 필요한 인계 상태와 실패 절차]
...
\addcontentsline{toc}{chapter}{심화 분석: 왜 하필 2026년 중순인가}
...
다섯 변곡점은 서로 독립된 유행이 아니라, 정책의 적용 범위가 넓어지면서 계획·기억·검증·평가·책임의 문제가 차례로 전면에 등장한 하나의 변화입니다.
...
\addcontentsline{toc}{section}{심화 분석 02: World model이 실행 스택으로 들어왔다}
...
\addcontentsline{toc}{section}{심화 분석 03: Memory·hierarchy·verifier의 분리}
...
\begin{profbox}[분산 평가가 줄이는 숨은 조건]
...
\addcontentsline{toc}{section}{심화 분석 05: 표준·규제가 assurance를 설계 요구로 만들었다}
